      ...
      try {
        ...
        if (response.ok) {
          ...
          if (resJson.success && resJson.url) {
            ...
            publicUrl = (resJson.url as string)
              .replace("https://yellowgreen-rook-384455.hostingersite.com", "https://www.globalawaaz.com")
              .replace("https://globalawaaz.com", "https://www.globalawaaz.com");
          } else {

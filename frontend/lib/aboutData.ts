...
export const defaultAboutData: AboutPageData = {
  ...
  missionDescHi: "GLOBAL AWAAZ का उद्देश्य देश और दुनिया के हर नागरिक तक बिना किसी पक्षपात के सटीक, सत्य और तथ्य-आधारित समाचार पहुंचाना है। हम जमीनी मुद्दों, शासन की पारदर्शिता और समाज के हर वर्ग की आवाज को प्रमुखता से उठाते हैं।",
  ...
  pillarsTitleHi: "GLOBAL AWAAZ के मुख्य स्तंभ",
  ...
  ethicsDescHi: "GLOBAL AWAAZ के सभी समाचार और रिपोर्ट कड़ी तथ्य-जांच (Fact Check) प्रक्रिया से गुजरते हैं। हम किसी भी भ्रामक जानकारी या सनसनीखेज खबरों को बढ़ावा नहीं देते।",

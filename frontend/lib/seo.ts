...
export const BASE_SEO_PAGES: SeoPageConfig[] = [
  ...
  {
    path: "/politics",
    pageName: "Politics (राजनीति)",
    metaTitle: "Politics & National Policy News (राजनीति समाचार) | Elections, Parliament & Analysis — Global Awaaz",
    metaDescription: "राजनीति, चुनाव, संसद, सरकारी नीतियों और राजनीतिक विश्लेषकों की निष्पक्ष व ताज़ा खबरें।",
    keywords: "Politics News Hindi, Election Updates, Political Analysis, Parliament, Government Policies",
    canonicalUrl: "https://www.globalawaaz.com/politics",
    ogTitle: "राजनीति एवं चुनाव समाचार — Global Awaaz",
    ogDescription: "देश की राजनीति और चुनावी हलचलों की सबसे तेज़ व सटीक रिपोर्टिंग।",
    ogImage: "https://images.unsplash.com/photo-1541872703-74c5e44368f9?w=1200&auto=format&fit=crop&q=80",
    ogType: "website",
    twitterCard: "summary_large_image",
    robots: "index, follow",
    jsonLdType: "CollectionPage"
  ...
  {
    path: "/crime",
    pageName: "Crime (अपराध / जुर्म)",
    metaTitle: "Crime News & Police Updates (अपराध / जुर्म समाचार) | Law, Justice & Investigation — Global Awaaz",
    metaDescription: "अपराध, पुलिस कार्रवाई, अदालती फैसले, साइबर क्राइम और कानून व्यवस्था से जुड़ी सबसे ताज़ा खबरें।",
    keywords: "Crime News Hindi, Police Updates, Cyber Crime, Court News, Law and Order",
    canonicalUrl: "https://www.globalawaaz.com/crime",
    ogTitle: "अपराध व कानून व्यवस्था समाचार — Global Awaaz",
    ogDescription: "अपराध और कानूनी जांच से जुड़ी प्रमुख घटनाओं की ग्राउंड रिपोर्ट।",
    ogImage: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=1200&auto=format&fit=crop&q=80",
    ogType: "website",
    twitterCard: "summary_large_image",
    robots: "index, follow",
    jsonLdType: "CollectionPage"
  ...
  {
    path: "/markets",
    pageName: "Markets (शेयर बाजार)",
    metaTitle: "Share Market & Stocks (शेयर बाजार समाचार) | Sensex, Nifty & IPO — Global Awaaz",
    metaDescription: "शेयर बाजार, सेंसेक्स, निफ्टी, आईपीओ, म्यूचुअल फंड और कमोडिटी मार्केट के लाइव अपडेट्स व विश्लेषण।",
    keywords: "Share Market Hindi, Stock Market News, Sensex, Nifty, IPO Updates, Commodities",
    canonicalUrl: "https://www.globalawaaz.com/markets",
    ogTitle: "शेयर बाजार व स्टॉक मार्केट समाचार — Global Awaaz",
    ogDescription: "दलाल स्ट्रीट, सेंसेक्स, निफ्टी और प्रमुख स्टॉक्स का रियल-टाइम विश्लेषण।",
    ogImage: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=1200&auto=format&fit=crop&q=80",
    ogType: "website",
    twitterCard: "summary_large_image",
    robots: "index, follow",
